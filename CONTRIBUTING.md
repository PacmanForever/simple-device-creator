...
- Use the [GitHub Issues](https://github.com/username/simple-device-creator/issues) to report bugs or request features
...
1. Clone the repository:
   ```bash
   git clone https://github.com/username/simple-device-creator.git
   cd simple-device-creator
   ```
